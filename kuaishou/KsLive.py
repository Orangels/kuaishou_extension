...
class Tool:
    ...
    def wssServerStart(self):
        ...
        # self.token = wssInfo['data']['result']
    ...
    def parseFeedPushPack(self, message: bytes):
        ...
        if 'commentFeeds' in data:
            logging.info('[parseFeedPushPack] [直播间弹幕🐎消息] [RoomId:' + self.liveRoomId + '] ｜ ' + data['commentFeeds'][0]['user']['userName'] + ' : ' + data['commentFeeds'][0]['content'])
        return data
